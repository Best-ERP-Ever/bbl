...
\newcommand{\tDate}{\mathtt{{Date}}}
\newcommand{\tTime}{\mathtt{{Time}}}
\newcommand{\tDateTime}{\mathtt{{DateTime}}}
\newcommand{\tCurrency}{\mathtt{{Currency}}}
\newcommand{\tQuantity}{\mathtt{{Quantity}}}
\newcommand{\tAny}{\mathtt{{Any}}}
\newcommand{\tChar}{\mathtt{{Char}}}
\newcommand{\tSchar}{\mathtt{{SChar}}}
\newcommand{\tUChar}{\mathtt{{UChar}}}
\newcommand{\tShort}{\mathtt{{Short}}}
\newcommand{\tChar}{\mathtt{{Char}}}
\newcommand{\tShortInt}{\mathtt{{Short Int}}}
\newcommand{\tSshort}{\mathtt{{SShort}}}
\newcommand{\tSshortint}{\mathtt{{Sshort Int}}}
\newcommand{\tUshort}{\mathtt{{UShort}}}
\newcommand{\tuShortInt}{\mathtt{{UShort Int}}}
\newcommand{\tSint}{\mathtt{{SInt}}}
\newcommand{\tUint}{\mathtt{{UInt}}}
\newcommand{\tLong}{\mathtt{{Long}}}
\newcommand{\tLongInt}{\mathtt{{Long Int}}}
\newcommand{\Slong}{\mathtt{{Slong}}}
\newcommand{\Slongint}{\mathtt{{Slong Int}}}
\newcommand{\tUlong}{\mathtt{{ULong}}}
\newcommand{\tULongInt}{\mathtt{{ULong Int}}}
\newcommand{\tLonglong}{\mathtt{{Long Long}}}
\newcommand{\tLonglongint}{\mathtt{{Long Long Int}}}
\newcommand{\tSlonglong}{\mathtt{{Slong Long}}}
\newcommand{\tSlonglongint}{\mathtt{{Slong Long Int}}}
\newcommand{\tUlonglong}{\mathtt{{ULong Long}}}
\newcommand{\tUlonglongint}{\mathtt{{ULong Long Int}}}
\newcommand{\tUlongdouble}{\mathtt{{Long  Double}}}
...
\begin{tabular}{lll}
  ...
  $\tDouble$ & IEEE double  & \lstinline|24.77477747747\\
  ...
  $\tDate$     & Date            & \lstinline|10/20/2026| \\
  $\tTime$   & Time         & \lstinline|03:50:00| \\
  $\tDateTime$ & DateTime     & \lstinline|Example| \\
  $\tCurrency$ & Currency  & \lstinline|Example|\\
  $\tQuantity$    & Quantity                         & \lstinline|Example|| \\
  $\tAny$  & Any                    & \lstinline|Example| \\
    $\tChar$ & NAME     & \lstinline|Example| \\
  $\tSChar$ & Name  & \lstinline|Example|\\
  $\tUChar$    & Name                        & \lstinline|Example|| \\
  $\tShort$  & Name                    & \lstinline|Example| \\
   $\tShortInt$ & NAME     & \lstinline|Example| \\
  $\tSshort$ & Name  & \lstinline|Example|\\
  $\tSshortint$    & Name                        & \lstinline|Example|| \\
  $\tUshort$  & Name                    & \lstinline|Example| \\
  $\tuShortInt$ & NAME     & \lstinline|Example| \\
  $\tSint$ & Name  & \lstinline|Example|\\
  $\tUint$    & Name                        & \lstinline|Example|| \\
  $\tLong$  & Name                    & \lstinline|Example| \\
   $\tLongInt$ & NAME     & \lstinline|Example| \\
  $\tSlong$ & Name  & \lstinline|Example|\\
  $\tSlongint$    & Name                        & \lstinline|Example|| \\
  $\tUlong$  & Name                    & \lstinline|Example| \\
  $\tULongInt$    & Name                        & \lstinline|Example|| \\
  $\tLonglong$  & Name                    & \lstinline|Example| \\
   $\tLonglongint$ & NAME     & \lstinline|Example| \\
  $\tSlonglong$ & Name  & \lstinline|Example|\\
  $\tSlonglongint$    & Name                        & \lstinline|Example|| \\
  $\tUlonglong$  & Name                    & \lstinline|Example| \\
  $\tUlonglongint$ & NAME     & \lstinline|Example| \\
  $\tUlongdouble$ & Name  & \lstinline|Example|\\
  \bottomrule
\end{tabular}
\end{center}
